...
class SalesReportPE extends StatelessWidget {
  const SalesReportPE({super.key});
          ...
          Expanded(
            child: ListView(
              ...
              children: const [
                _ReportInfo(
                  name: 'Cash Sales',
                  info: 'All Sales made on cash',
                  price: 'UGX 100',
                ),
                _ReportInfo(
                  name: 'Credit Sales',
                  info: 'Sales made on credit',
                  price: 'UGX 100',
                ),
                _ReportInfo(
                  name: 'Returns',
                  info: 'Sales returned from customers',
                  price: 'UGX 100',
                ),
                _ReportInfo(
                  name: 'Wallet Sales',
                  info: 'Sales sold through customer wallets',
                  price: 'UGX 100',
                ),
                _ReportInfo(
                  name: 'Wallet Sales',
                ...
                _ReportInfo(
                  name: 'On hold Sales',
                  info: 'Sales that has not been cashed in',
                  price: 'UGX 100',
                ),
              ],
            ),
